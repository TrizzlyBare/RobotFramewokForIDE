...
#         ELSE IF    '${language}' == 'JavaScript'
#             ${result}    Run Process    ${JAVASCRIPT_CMD}    ${TEMP_DIR}/${filename}${ext}    input=${input}    shell=True
#             ${output}    Set Variable    ${result.stdout.strip()}
#         END
#     EXCEPT    AS    ${error}
#         ${status}    Set Variable    runtime_error
...
#             RETURN    ${topic}[example_code][${problem_name}][input]
#         END
#     END
...
#         ${teacher_match}    Get Teacher With Matching Language    ${teachers}    ${first_submission}[language]
...
#                 ${teacher_status}    ${teacher_output}    Run Keyword If    "${input}" != ""
...
#                     Add Comparison Result    ${results}    ${student_name}    ${topic_name}    ${problem_name}
#                     ...    FAIL    Student output mismatch: "${student_output}" != "${teacher_output}"    ${student_submission}[language]
#                 ELSE
#                     Add Comparison Result    ${results}    ${student_name}    ${topic_name}    ${problem_name}
#                     ...    PASS    Student output matches teacher output    ${student_submission}[language]
#             END
#         END
#     END
#     END
